...
def train(model, loader_train, loader_valid, optimizer,criterion, n_epochs,device,wname):
    ...
    for epoch in range(n_epochs):
        ...
        print ('Epoch %d/%d, Tr Loss: %.4f, Tr Acc: %.4f, Val Loss: %.4f, Val Acc: %.4f'
               %(epoch+1, n_epochs, train_loss[-1], train_accuracy[-1], valid_loss[-1], valid_accuracy[-1]))

...
def randomStimuli(numTrials):
    ...
    image_list=[]
    video_list=[]
    image_list = randomlist(numTrials,0,1)
    video_list = randomlist(numTrials,2,3)
    return image_list,video_list

def randomlist(num_range,nmin,nmax):
    return_list = []
    left_i = 0
    right_i = 0
    for i in range(num_range):
        ...
        if num == nmin:
            if left_i != 10:
                ...
                return_list.append(nmax)
        elif num == nmax:
            if right_i != 10:
                return_list.append(num)
                right_i += 1
            else:
                return_list.append(nmin)

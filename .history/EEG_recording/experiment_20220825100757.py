...
for cat in categories:
    l = get_filenames_in_path(f"{IMAGE_FOLDER}{CATEGORIES}")
    stimuli.append(f'{IMAGE_FOLDER}{CATEGORIES}{"/"}{l[0]}')
    ...
    if 'space' in keys:      # If space has been pushed
        ...
        for session in range(num_session):
            ...
            for block in range(num_block):
                ...
                block_marker = {1:1.0 , 2:2.0 , 3:1.0 , 4:2.0 }
                #12 trials
...
marker_channel = board_shim.get_marker_channel(args.board_id)

...
def main():
    ...
    global PLAY_VIDEO
    #Window setup
    Mon = monitors.Monitor('MONITOR/DELA0DB')
    mywin = visual.Window(SCREEN_SIZE, color="black",monitor="Experiment Monitor" , units='norm',monitors=Mon)
    #erdWin = visual.Window(SCREEN_SIZE, color="black",monitor="ERD view" , units='norm')
    stimuli = get_stimuli()

...
def main():
    ...
    board_shim.start_stream(35000000, "file://brainflow_data.csv:w")
                ...
                for block in range(NUM_BLOCK):
                    ...
                    for trials in range(NUM_TRIAL):
                        ...
                        if PLAY_VIDEO == True:
                            ...
                            playVideo(f"{stim[numVi_list[trials]]}",BLOCK_MARKER[numVi_list[trials]],STIM_TIME,board_shim,mywin)                            #b.hear('A_')
                            drawFixation(FIXATION_TIME,board_shim,mywin)
                            STIM_CHECK += 1
                            print(STIM_CHECK)
                        else:

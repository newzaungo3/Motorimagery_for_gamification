...
def main():
    ...
    while True:
        ...
        if '1' in resp_key:
            start = time.time()
            drawTextOnScreen(f'Selected baseline',mywin)
            startExperiment(1,board_shim,mywin)
            stop  = time.time()
            ...
            start = time.time()
            drawTextOnScreen(f'Selected executed',mywin)
            startExperiment(2,board_shim,mywin)
            stop  = time.time()
            print(f"Total experiment time = {(stop-start)/60} ")
            core.wait(10)
            break
            ...
            start = time.time()
            drawTextOnScreen(f'Selected imagine',mywin)
            startExperiment(3,board_shim,mywin)
            stop  = time.time()
            print(f"Total experiment time = {(stop-start)/60} ")
            core.wait(10)
            break
